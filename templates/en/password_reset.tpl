<html>
  <head>
    ...
    <title>Speza Exchange - Reset Your Password</title>
    <style type="text/css">
      body{
        margin: 0 auto;
        padding: 0;
    ...
    <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr class="speza">
        <td style="padding: 20px;">
          <img src="https://i.imgur.com/tH3ti99.jpeg" class="speza">
        </td>
      </tr>
      <tr class="header">
      ...
      <tr class="header">
        <td style="padding: 20px;">
        <img src="https://i.imgur.com/SXqS04I.png" class="image">
        </td>
      </tr>
      <tr class="content">
        <td style="padding:10px;">
          <p>
            Hi / 你好 <b>{{ .record.user.email }}</b>, <br/>
          ...
          <table bgcolor="#823179" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
            <tr>
              <td class="button" height="45">
                <a href="{{ .ResetPasswordURI }}" target="_blank">RESET</a>
              </td>
            </tr>
          </table>
        </td>
